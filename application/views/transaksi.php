...
<input type="submit" id="tbtr"  name="action" class="btn btn-primary btn-lg btn-block" value="" />
         ...
         $('#csetor').on('keyup', function() {
          var REKENING = $('#csetor').val();
                ...
                {  
                  ...
                  $("#str").val("");
                  setTimeout(function(){ $("#str").focus(); }, 1000);
                ...
                $.ajax({  
                     ...
                     {  
                      ...
                      if ($("#tbtr").val() == "tarik" && data !== "saldo"  ) {
                       ...
                       setTimeout(function(){ $('.box2').hide(); }, 2000); 
                       location.reload();
