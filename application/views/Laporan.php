...
<div class="container box pilih" id="psnasaba">
  <div class="row">
    ...
    <div class="col-3">
      <input id="dari1" type="text" class="form-control tanggal" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
    </div>
    <div class="col-3">
      <input id="sampai1" type="text" class="form-control tanggal" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
...
<div class="container box pilih1" id="pnasaba" >
  ...
  <div class="row">
    ...
    <div class="col-3">
      <input type="text" class="form-control tanggal" id="dari2" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
    </div>
    <div class="col-3">
      <input type="text" class="form-control tanggal" id="sampai2" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
  ...
  <div class="row" id="">
    ...
    <div class="col-4">
        ...
        <span id="user_uploaded_image">
          <img id="gbnsb" src="http://localhost/tabungan_pondok/upload/profil.png" alt="..." class="img-thumbnail" width="400px" >
